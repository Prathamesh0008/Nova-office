...
//     // TODO: wire up to your backend / EmailJS / Formspree / API route
//     // Simulate request:
...
//                     <path d="M9 6V4a2 2 0 0 1 2-2h2a2 2 0 0 1 2 2v2h3a2 2 0 0 1 2 2v4h-6v1a2 2 0 0 1-2 2h-2a2 2 0 0 1-2-2v-1H2V8a2 2 0 0 1 2-2h5Zm2-2h2v2h-2V4Zm11 10v4a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2v-4h7v1a2 2 0 0 0 2 2h2a2 2 0 0 0 2-2v-1h7Z"/>
//                   </svg>
//                 </div>
//                 <h3 className="text-lg font-semibold">Sales & Bulk Orders</h3>
//               </div>
//               <p className="mt-2 text-sm text-white/80">
//                 For quotations, lead times, and export paperwork.
//               </p>
//               <a href="mailto:sales@yourpharma.com" className="mt-3 inline-block font-medium underline underline-offset-4">
//                 sales@yourpharma.com
//               </a>
//             </div>
...
//                   {/* certificate icon */}
//                   <svg className="h-5 w-5" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
//                     <path d="M6 2h9a2 2 0 0 1 2 2v9.5l-2-1-2 1-2-1-2 1-2-1-2 1V4a2 2 0 0 1 2-2Zm-2 15.5 2-1 2 1 2-1 2 1 2-1 2 1V22l-2-1-2 1-2-1-2 1-2-1-2 1v-4.5Z"/>
//                   </svg>
//                 </div>
//                 <h3 className="text-lg font-semibold">Quality & GMP Docs</h3>
//               </div>
//               <p className="mt-2 text-sm text-white/80">
//                 COA, MSDS, stability, or regulatory support.
//               </p>
//               <a href="mailto:quality@yourpharma.com" className="mt-3 inline-block font-medium underline underline-offset-4">
//                 quality@yourpharma.com
//               </a>
//             </div>
...
//                 <li>Amsterdam, NL</li>
//               </ul>
//               <p className="mt-3 text-sm text-white/80">+91 00000 00000</p>
//             </div>
//           </aside>

//           {/* Right: form */}
//           <section className="lg:col-span-2">
//             <form onSubmit={onSubmit} className="rounded-2xl bg-white p-6 shadow-xl ring-1 ring-black/5">
//               <h2 className="text-2xl font-bold text-[#314977]">Send us a message</h2>
...
//                           className="mt-1 w-full rounded-lg border border-slate-300 bg-white px-3 py-2 focus:border-[#3386BC] focus:outline-none focus:ring-2 focus:ring-[#3386BC]/30">
...
//                             className="mt-1 w-full rounded-lg border border-slate-300 px-3 py-2 focus:border-[#3386BC] focus:outline-none focus:ring-2 focus:ring-[#3386BC]/30"></textarea>
//                 </div>
//                 <div className="sm:col-span-2">
//                   <label className="flex items-start gap-2 text-sm text-slate-700">
//                     <input type="checkbox" required className="mt-1 h-4 w-4 rounded border-slate-300 text-[#314977] focus:ring-[#3386BC]" />
//                     I consent to processing my data according to the Privacy Policy.
//                   </label>
//                 </div>
//               </div>
...
//                 </button>
//                 <a href="mailto:sales@yourpharma.com" className="text-sm font-medium text-[#314977] underline underline-offset-4">
//                   or email sales@yourpharma.com
//                 </a>
//               </div>
//             </form>
//           </section>
